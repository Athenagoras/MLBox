...
class Categorical_encoder():
    ...
    Parameters
    ----------
        - strategy : string, defaut = "label_encoding". The strategy to encode categorical features. Available strategies = "label_encoding", "dummification", "random_projection", "entity_embedding"
    ...
    def fit(self, df_train, y_train):
        ...
        Parameters
        ----------
            * df_train : pandas dataframe of shape = (n_train, n_features). The train dataset with numerical and categorical features. NA values are allowed.
